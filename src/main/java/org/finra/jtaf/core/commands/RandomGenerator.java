...
public class RandomGenerator extends Command {
     ...
     *
     * @param method    - the method to be used. Either abbrevUSState, USState, phone,
     *                  number, or string
     * @param length    - length of number or string to be generated. lengthMin,
     *                  lengthMax, min, and max should not be specified when using
     *                  this parameter.
     * @param lengthMin - used to specify minimum length of random string generated
     * @param lengthMax - used to specify maximum length of random string generated
     * @param min       - used to specify minimum length of random number generated
     * @param max       - used to specify maximum length of random number generated
     * @param regexp    - regular expression to be used for string generation. This
     ...
     *
     * @param regexp - regular expression to be used to generate the string
     * @return the randomly generated string
     */
     ...
     * length.
     *
     * @param chars  - The characters to be used
